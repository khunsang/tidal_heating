...
if len (indices_4s) !=0:
    ...
    print ("min max chirp_mass_samples", min(chirp_mass_samples), max(chirp_mass_samples))
    print ("min max q_samples", min(q_samples), max(q_samples))
    print ("min max m1_samples", min(m1_samples), max(m1_samples))
    print ("min max m2_samples", min(m2_samples), max(m2_samples))
